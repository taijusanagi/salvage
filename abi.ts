export const abi = [
  {
    inputs: [
      { internalType: "address", name: "_chocomintERC721Address", type: "address" },
      { internalType: "uint256", name: "_mintPrice", type: "uint256" },
      { internalType: "uint256", name: "_supplyLimit", type: "uint256" },
      { internalType: "uint256", name: "_saleStartTimestamp", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IChocoMintERC721", name: "", type: "address" }],
  ...
  { inputs: [], name: "sell", outputs: [], stateMutability: "payable", type: "function" },
  {
    inputs: [{ internalType: "address", name: "account", type: "address" }],
    name: "shares",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
